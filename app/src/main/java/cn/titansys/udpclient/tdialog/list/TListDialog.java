package cn.titansys.udpclient.tdialog.list;

import static cn.titansys.udpclient.tdialog.base.BaseDialogFragment.getScreenHeight;
import static cn.titansys.udpclient.tdialog.base.BaseDialogFragment.getScreenWidth;
...
import cn.titansys.udpclient.tdialog.base.TBaseAdapter;
import cn.titansys.udpclient.tdialog.base.TController;
...
public class TListDialog extends TDialog {
    ...
    protected void bindView(View view) {
        ...
        if (tController.getAdapter() != null) {//有设置列表
            ...
            @SuppressLint("WrongConstant") RecyclerView.LayoutManager layoutManager = new LinearLayoutManager(view.getContext(),tController.getOrientation(),false);
